...
(function () {
  ...
  function select() {
    ...
    Render.header(false, "International System of Units Flashcards");
		
		document.querySelectorAll('.deckmenu__deck').forEach( (el) => {
			el.addEventListener('click', (e) => {
				//make fullscreen if on mobile (header click exists fullscreen)
				if (/Android|webOS|iPhone|iPad|BlackBerry|Windows Phone|Opera Mini|IEMobile|Mobile/i.test(navigator.userAgent) && screenfull.enabled) {
					screenfull.request();
